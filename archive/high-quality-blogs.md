...
- **Platform**: GitHub Pages (Markdown-based)
- **Auth**: None
- **Extraction**: `python scripts/authenticated_extract.py "URL"`
...
```bash
# Use .venv/bin/python (no conda needed)

# Test with default settings
.venv/bin/python scripts/authenticated_extract.py "URL_OF_A_POST" --no-images

# If output is empty or noisy, try common selectors:
.venv/bin/python scripts/authenticated_extract.py "URL_OF_A_POST" -s "article" --no-images
.venv/bin/python scripts/authenticated_extract.py "URL_OF_A_POST" -s "article, main" --no-images
.venv/bin/python scripts/authenticated_extract.py "URL_OF_A_POST" -s ".post-content, .entry-content" --no-images
